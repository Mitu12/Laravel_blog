...
<head>
	...
	<link href="{{asset('public/admin_asset/css/http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&subset=latin,cyrillic-ext,latin-ext' )}}"rel='stylesheet' type='text/css'>
	<!-- end: CSS -->
					...
					<h2>Login to your account</h2>
						...
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="admin_email" id="username" type="text" placeholder="Email"/>
							</div>
