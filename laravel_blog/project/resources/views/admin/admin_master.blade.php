...
<head>
	...
	<link href="{{asset('public/admin_asset/http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800&subset=latin,cyrillic-ext,latin-ext')}}" rel='stylesheet' type='text/css'>
	<!-- end: CSS -->
...
<body>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/add-blog')}}"><i class="icon-picture"></i><span class="hidden-tablet"> Add Blog</span></a></li>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2013 <a href="{{asset('public/admin_asset/http://jiji262.github.io/Bootstrap_Metro_Dashboard/')}}" alt="Bootstrap_Metro_Dashboard">Bootstrap Metro Dashboard</a></span>
